...
public class MultiplicacaoCommand implements CommandHandler {

    @Override
    public Response handle(Request request) {
        if (request.getArgs().size() != 2) {
            return Response.badResquest("Uso: multiplicacao <num1> <num2>");
        }
        ...
        try {
            ...
            return Response.badResquest("Os argumentos devem ser numeros.");
        }
    }
}
